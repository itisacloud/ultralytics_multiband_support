...
def create_markdown(py_filepath: Path, module_path: str, classes: list, functions: list):
    ...
    title_content = (
        ...
        f"!!! Note\n\n"
        f"    This file is available at [{url}]({url}). If you spot a problem please help fix it by [contributing](https://docs.ultralytics_MB.com/help/contributing/) a [Pull Request]({edit}) 🛠️. Thank you 🙏!\n\n"
    )
