...
"""
Helper file to build ultralytics_MB Docs reference section. Recursively walks through ultralytics_MB dir and builds an MkDocs
...
def create_markdown(py_filepath: Path, module_path: str, classes: list, functions: list):
    ...
    title_content = (
        ...
        f"(https://docs.ultralytics_MB.com/help/contributing/) a [Pull Request]({edit}) 🛠️. Thank you 🙏!\n\n"
    )
