...
from ultralytics_MB.utils import LOGGER, yaml_load
...
class BaseSolution:
    """A class to manage all the ultralytics_MB Solutions: https://docs.ultralytics_MB.com/solutions/."""
    ...
    def __init__(self, **kwargs):
        ...
        LOGGER.info(f"ultralytics_MB Solutions: ✅ {self.CFG}")
    ...
    def display_output(self, im0):
        ...
        if self.CFG.get("show") and self.env_check:
            cv2.imshow("ultralytics_MB Solutions", im0)
