...
from ultralytics_MB.hub.utils import HELP_MSG, HUB_WEB_ROOT, PREFIX, TQDM
from ultralytics_MB.utils import IS_COLAB, LOGGER, SETTINGS, __version__, checks, emojis
...
class HUBTrainingSession:
    """
    HUB training session for ultralytics_MB HUB YOLO models. Handles model initialization, heartbeats, and checkpointing.

    Attributes:
        model_id (str): Identifier for the YOLO model being trained.
        model_url (str): URL for the model in ultralytics_MB HUB.
        rate_limits (dict): Rate limits for different API calls (in seconds).
        timers (dict): Timers for rate limiting.
        metrics_queue (dict): Queue for the model's metrics.
        model (dict): Model data fetched from ultralytics_MB HUB.
    """
        ...
        try:
            ...
            if identifier.startswith(f"{HUB_WEB_ROOT}/models/") and not self.client.authenticated:
                LOGGER.warning(
                    ...
                    "You can find your API Key at: https://hub.ultralytics_MB.com/settings?tab=api+keys."
                )
    ...
    def load_model(self, model_id):
        """Loads an existing model from ultralytics_MB HUB using the provided model identifier."""
    ...
    def _parse_identifier(identifier):
        ...
        The method supports different identifier formats:
            - A HUB model URL https://hub.ultralytics_MB.com/models/MODEL
            - A HUB model URL with API Key https://hub.ultralytics_MB.com/models/MODEL?api_key=APIKEY
    ...
    def _set_train_args(self):
        """
        Initializes training arguments and creates a model entry on the ultralytics_MB HUB.
    ...
    def upload_metrics(self):
        """Upload model metrics to ultralytics_MB HUB."""
    ...
    def upload_model(
        ...
        """
        Upload a model checkpoint to ultralytics_MB HUB.
        ...
        if not weights.is_file():
            ...
            if final and last.is_file():
                LOGGER.warning(
                    ...
                    "For more reliable training, consider using ultralytics_MB HUB Cloud. "
                    "Learn more at https://docs.ultralytics_MB.com/hub/cloud-training."
                )
