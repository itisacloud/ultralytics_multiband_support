...
def utralytics_explorer_docs_callback():
    ...
    with st.container(border=True):
        ...
        st.markdown(
            "<p>This demo is built using ultralytics_MB Explorer API. Visit <a href='https://docs.ultralytics_MB.com/datasets/explorer/'>API docs</a> to try examples & learn more</p>",
...
def layout(data=None, model=None):
    ...
    st.markdown("<h1 style='text-align: center;'>ultralytics_MB Explorer Demo</h1>", unsafe_allow_html=True)
