...
from ultralytics_MB.data.utils import polygons2masks, polygons2masks_overlap
...
class Mosaic(BaseMixTransform):
    ...
    Examples:
        >>> from ultralytics_MB.data.augment import Mosaic
...
class MixUp(BaseMixTransform):
    ...
    Examples:
        >>> from ultralytics_MB.data.augment import MixUp
        >>> dataset = YourDataset(...)  # Your image dataset
...
class RandomHSV:
    ...
    Examples:
        >>> import numpy as np
        >>> from ultralytics_MB.data.augment import RandomHSV
    ...
    def __call__(self, labels):
        ...
        Args:
            labels (Dict): A dictionary containing the following keys:
                ...
                'instances' (ultralytics_MB.utils.instance.Instances): An object containing bounding boxes and
                    optionally keypoints.

        Returns:
            (Dict): The same dictionary with the flipped image and updated instances:
                'img' (numpy.ndarray): The flipped image.
                'instances' (ultralytics_MB.utils.instance.Instances): Updated instances matching the flipped image.
    ...
    def __call__(self, labels):
        ...
        Args:
            labels (Dict): A dictionary containing:
                ...
                - 'instances' (ultralytics_MB.engine.results.Instances): Object containing bounding boxes, segments, etc.
