...
class NASPredictor(BasePredictor):
    """
    ultralytics_MB YOLO NAS Predictor for object detection.

    This class extends the `BasePredictor` from ultralytics_MB engine and is responsible for post-processing the
