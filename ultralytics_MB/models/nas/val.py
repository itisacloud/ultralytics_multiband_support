...
class NASValidator(DetectionValidator):
    """
    ultralytics_MB YOLO NAS Validator for object detection.

    Extends `DetectionValidator` from the ultralytics_MB models package and is designed to post-process the raw predictions
