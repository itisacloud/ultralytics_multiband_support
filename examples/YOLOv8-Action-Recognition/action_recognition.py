...
from ultralytics_MB.data.loaders import get_best_youtube_url
...
def parse_opt():
    ...
    parser.add_argument("--weights", type=str, default="yolov8n.pt", help="ultralytics_MB detector model path")
